...
#SBATCH --job-name=pc_net_hdi_100_dep

#SBATCH --error=pc_net_hdi_100_dep%j.err

#SBATCH --output=pc_net_hdi_100_dep%j.out
...
Rscript  --vanilla ~/hdi_simu/pc_net_power_simu_100_log.R 100 100 500 500 log_new_pc_net_hdi_simu_100_dep ${SLURM_ARRAY_TASK_ID}
