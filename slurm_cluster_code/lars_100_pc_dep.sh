...
#SBATCH --job-name=PC_adap_hdi_100_dep

#SBATCH --error=PC_adap_hdi_100_dep%j.err

#SBATCH --output=PC_adap_hdi_100_dep%j.out
...
Rscript  --vanilla ~/hdi_simu/pc_power_simu_100_dep.R 100 100 500 500 pc_Aadp_hdi_simu_100_dep ${SLURM_ARRAY_TASK_ID}
