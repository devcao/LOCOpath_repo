...
#SBATCH --job-name=log_12pc_net_12_dep

#SBATCH --error=log_12pc_net_12_dep%j.err

#SBATCH --output=log_12pc_net_12_dep%j.out
...
Rscript  --vanilla ~/hdi_simu/pc_net_power_simu_12_log_new_est.R 100 12 500 500 log_new_est_pc_net_hdi_simu_12_dep ${SLURM_ARRAY_TASK_ID}
