...
#SBATCH --job-name=Nlog_80_dep

#SBATCH --error=Nlog_80_dep%j.err

#SBATCH --output=Nlog_80_dep%j.out
...
Rscript  --vanilla ~/hdi_simu/pc_new_net_power_simu_80_log.R 100 80 500 500 log_new_new_pc_net_hdi_simu_80_dep ${SLURM_ARRAY_TASK_ID}
