...
#SBATCH --job-name=log_1k_multi_dep

#SBATCH --error=log_1k_multi_dep%j.err

#SBATCH --output=log_1k_multi_dep%j.out
...
Rscript  --vanilla ~/hdi_simu/pc_power_simu_multi_log.R 100 1000 500 500 log_mmulti_pc_hdi_simu_dep ${SLURM_ARRAY_TASK_ID}
