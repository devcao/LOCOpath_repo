...
#SBATCH --job-name=pc_ttest_80_dep

#SBATCH --error=pc_hdi_ttest_dep_80%j.err

#SBATCH --output=pc_hdi_ttest_dep_80%j.out
...
Rscript  --vanilla ~/hdi_simu/power_simu_ttest_80.R 100 80 500 ${SLURM_ARRAY_TASK_ID}
