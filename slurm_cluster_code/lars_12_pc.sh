...
#SBATCH --job-name=pc_hdi_12

#SBATCH --error=pc_hdi_12%j.err

#SBATCH --output=pc_hdi_12%j.out
...
Rscript  --vanilla ~/hdi_simu/pc_power_simu_12.R 100 12 500 500 pc_hdi_simu_12 ${SLURM_ARRAY_TASK_ID}
