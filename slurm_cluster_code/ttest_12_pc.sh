...
#SBATCH --job-name=pc_ttest_12_dep

#SBATCH --error=pc_hdi_ttest_dep%j.err

#SBATCH --output=pc_hdi_ttest_dep%j.out
...
Rscript  --vanilla ~/hdi_simu/power_simu_ttest_12.R 100 12 500 ${SLURM_ARRAY_TASK_ID}
