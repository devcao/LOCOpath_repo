...
#SBATCH --job-name=glog_80_multi_dep

#SBATCH --error=glog_80_multi_dep%j.err

#SBATCH --output=glog_80_multi_dep%j.out
...
Rscript  --vanilla ~/hdi_simu/pc_glasso_multi_log_80.R 100 80 500 500 log_glasso_multi_beta05_80_pc_hdi_simu_dep ${SLURM_ARRAY_TASK_ID}
