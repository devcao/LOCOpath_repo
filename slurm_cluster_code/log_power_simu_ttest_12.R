...
results = Logistic.Wald.Test.Power(n = n, p = p, beta=c(bb,rep(1,2),rep(0, 9)), rho=rho, iter = iter, which.covariate = 1, betaNull = 0)

print(mem_used())
f1 = paste0("~/hdi_simu/results/log_large_sig_pc_12ttest_",p,"_", 'rho',rho,'beta_',bb,".RData")
