...
#SBATCH --job-name=log_1kpc_net_12_dep

#SBATCH --error=log_1kpc_net_12_dep%j.err

#SBATCH --output=log_1kpc_net_12_dep%j.out
...
Rscript  --vanilla ~/hdi_simu/pc_net_power_simu_1000_log_new_est.R 100 1000 500 500 log_new_est_pc_net_hdi_simu_1000_dep ${SLURM_ARRAY_TASK_ID}
