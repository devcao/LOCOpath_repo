...
#SBATCH --job-name=rerun_hdi_12

#SBATCH --error=rerun_hdi_12%j.err

#SBATCH --output=rerun_hdi_12%j.out
...
Rscript  --vanilla ~/hdi_simu/power_simu_12.R 100 12 500 500 hdi_simu_12 ${SLURM_ARRAY_TASK_ID}
