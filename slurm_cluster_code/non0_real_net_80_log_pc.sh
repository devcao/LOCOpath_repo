...
#SBATCH --job-name=pc_non0_8log_80_dep

#SBATCH --error=pc_non0_8log_80_dep%j.err

#SBATCH --output=pc_non0_8log_80_dep%j.out
...
Rscript  --vanilla ~/hdi_simu/non0_pc_net_power_simu_80_log.R 100 80 500 500 non0_log_pc_net_hdi_simu_80_dep ${SLURM_ARRAY_TASK_ID}
