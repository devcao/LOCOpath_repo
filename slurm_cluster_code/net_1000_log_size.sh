...
#SBATCH --job-name=size_net_hdi_1000_dep

#SBATCH --error=size_net_hdi_1000_dep%j.err

#SBATCH --output=size_net_hdi_1000_dep%j.out
...
Rscript  --vanilla ~/hdi_simu/pc_net_power_simu_1000_log.R 100 1000 500 5000 log_size_new_pc_net_hdi_simu_1000_dep ${SLURM_ARRAY_TASK_ID}
