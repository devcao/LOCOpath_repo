...
#SBATCH --job-name=t_log_80_multi_dep

#SBATCH --error=t_log_80_multi_dep%j.err

#SBATCH --output=t_log_80_multi_dep%j.out
...
Rscript  --vanilla ~/hdi_simu/pc_test_power_simu_multi_log_80.R 100 80 500 500 log_new_alter_multi_80_pc_hdi_simu_dep ${SLURM_ARRAY_TASK_ID}
