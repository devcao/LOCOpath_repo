...
#SBATCH --job-name=size80_log_80_dep

#SBATCH --error=size80_log_80_dep%j.err

#SBATCH --output=size80_log_80_dep%j.out
...
Rscript  --vanilla ~/hdi_simu/size_net_power_simu_80_log.R 100 80 500 5000 log_size_3inter_new_pc_net_hdi_simu_80_dep ${SLURM_ARRAY_TASK_ID}
