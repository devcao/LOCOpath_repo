...
#SBATCH --job-name=pc_net_hdi_1k_dep

#SBATCH --error=pc_net_hdi_1k_dep%j.err

#SBATCH --output=pc_net_hdi_1k_dep%j.out
...
Rscript  --vanilla ~/hdi_simu/pc_net_power_simu_1000_dep.R 100 1000 500 500 ext_pc_net_Aadp_hdi_simu_1000_dep ${SLURM_ARRAY_TASK_ID}
