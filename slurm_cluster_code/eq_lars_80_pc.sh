...
#SBATCH --job-name=eq80_hdi_80_dep

#SBATCH --error=eq80_hdi_80_dep%j.err

#SBATCH --output=eq80_hdi_80_dep%j.out
...
Rscript  --vanilla ~/hdi_simu/pc_eq_power_simu_80.R 100 80 500 500 pc_right_eq_hdi_simu_80_dep ${SLURM_ARRAY_TASK_ID}
