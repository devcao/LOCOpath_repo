...
results = desparse.Power(n = n, p = p, beta=c(bb,rep(1,2),rep(0, 97)), rho=rho, iter = iter,  setting = 'dep', which.covariate = 1, betaNull = 0)

print(mem_used())
f1 = paste0("~/hdi_simu/results/pc_new_proj_",p,"_", 'rho',rho,'beta_',bb,".RData")
