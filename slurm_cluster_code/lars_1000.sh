...
#SBATCH --job-name=rerun_hdi_1000

#SBATCH --error=rerun_hdi_1000%j.err

#SBATCH --output=rerun_hdi_1000%j.out
...
Rscript  --vanilla ~/hdi_simu/power_simu_1000.R 100 1000 500 500 hdi_simu_1000 ${SLURM_ARRAY_TASK_ID}
