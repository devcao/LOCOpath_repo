...
results = Net.Resample.Logistic.Power(n = n, p = p, beta=c(0+bb,rep(1,2),rep(0,9)), rho=rho, iter = iter, B = B, setting = 'dep', which.covariate = 1, betaNull = 0, multiTest = FALSE, parallel = TRUE, norm = 'L2.squared', beta.init = 'adaptive')
...
results = Net.Resample.Logistic.Power(n = n, p = p, beta=c(0+bb,rep(1,2),rep(0,9)), rho=rho, iter = iter, B = B, setting = 'dep', which.covariate = 1, betaNull = 0, multiTest = FALSE, parallel = TRUE, norm = 'L1', beta.init = 'adaptive')
print(results)
...
results = Net.Resample.Logistic.Power(n = n, p = p, beta=c(0+bb,rep(1,2),rep(0,9)), rho=rho, iter = iter, B = B, setting = 'dep', which.covariate = 1, betaNull = 0, multiTest = FALSE, parallel = TRUE, norm = 'L_inf', beta.init = 'adaptive')
print(results)
