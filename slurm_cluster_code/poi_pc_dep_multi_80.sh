...
#SBATCH --job-name=poi_80pc_hdi_multi_dep

#SBATCH --error=poi_80pc_hdi_multi_dep%j.err

#SBATCH --output=poi_80pc_hdi_multi_dep%j.out
...
Rscript  --vanilla ~/hdi_simu/pc_power_simu_multi_poi_80.R 100 80 500 500 poi_80_multi_pc_hdi_simu_dep ${SLURM_ARRAY_TASK_ID}
