...
results = FTest.Power(n = n, p = p, beta=c(1+bb,rep(1,2),rep(0, 77)), rho=rho, iter = iter,  setting = 'dep', which.covariate = 1, betaNull = 1)

print(mem_used())
f1 = paste0("~/hdi_simu/results/pc_ftest3rd_",p,"_", 'rho',rho,'beta_',bb,".RData")
