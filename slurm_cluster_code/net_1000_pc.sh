...
#SBATCH --job-name=pc_alpha_net_hdi_1k_dep

#SBATCH --error=pc_alpha_net_hdi_1k_dep%j.err

#SBATCH --output=pc_alpha_net_hdi_1k_dep%j.out
...
Rscript  --vanilla ~/hdi_simu/pc_alpha_net_power_simu_1000.R 100 1000 500 500 pc_alpha_net_hdi_simu_1000 ${SLURM_ARRAY_TASK_ID}
