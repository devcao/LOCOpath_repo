...
#SBATCH --job-name=eq1k_hdi_80_dep

#SBATCH --error=eq1k_hdi_80_dep%j.err

#SBATCH --output=eq1k_hdi_80_dep%j.out
...
Rscript  --vanilla ~/hdi_simu/pc_eq_power_simu_1000.R 100 1000 500 500 pc_right_eq_hdi_simu_1000_dep ${SLURM_ARRAY_TASK_ID}
