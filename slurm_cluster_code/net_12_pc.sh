...
#SBATCH --job-name=pc_net_12_dep

#SBATCH --error=pc_net_12_dep%j.err

#SBATCH --output=pc_net_12_dep%j.out
...
Rscript  --vanilla ~/hdi_simu/pc_net_power_simu_12_dep.R 100 12 500 500 ext_pc_net_hdi_simu_12_dep ${SLURM_ARRAY_TASK_ID}
