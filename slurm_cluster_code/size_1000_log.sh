...
#SBATCH --job-name=size_1k_hdi

#SBATCH --error=size_1k_hdi%j.err

#SBATCH --output=size_1k_hdi%j.out
...
Rscript  --vanilla ~/hdi_simu/size_net_power_simu_1000_log.R 100 1000 500 500 size_log_net_1000 ${SLURM_ARRAY_TASK_ID}
